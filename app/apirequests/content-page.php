...
$resp->moduleName = $mmAPIRequestsT->NameModule;
$resp->headTitle = $mmAPIRequestsT->NameModule;
$resp->headLogoutAuto = true;
$resp->navInclude = true;
$resp->contentHeader = $mmAPIRequestsT->FontAwesome . STR_NBSP . $mmAPIRequestsT->NameModule;
...
if ( CONTENT_LOAD_NOW ) {
	...
	$resp->scriptsOnLoadA[] = <<< JS
        xanDo( { "Do": "Init", "Msg": "Init Elements", "URL": "{$mmAPIRequestsT->URLDoRelative}" } );
JS;

} else {
	$resp->scriptsOnLoadA[] = <<< JS
        xanDo( { "Do": "ContentLoadAll", "Msg": "Load Content and Init Elements", "URL": "{$mmAPIRequestsT->URLDoRelative}", "IDContacts": "{$resp->reqID}" } );
JS;
}
...
//language=javascript
$modalButtonActionOnClick = "xanDo( { 'Do': '{$xanDoDo}', 'Msg': 'Contact Create', 'URL': '{$mmAPIRequestsT->URLDoRelative}' } );";
	...
	$resp->scriptsExtraA[] = <<< JS
        function ContactsNameUpdate( event ) {
            setTimeout( function ( ele ) {
                ...
                xanDo( { "Do": "ContactsNameUpdate", "Msg": "Name Update", "URL": "{$mmAPIRequestsT->URLDoRelative}", "IDContacts": eleUUID } );
            }, 1000, $( this ) );
        }
JS;
	...
	$modalButtonActionOnClick = /** @lang JavaScript */
		"xanDo( { 'Do': '{$xanDoDo}', 'Msg': 'Contact Duplicate', 'URL': '{$mmAPIRequestsT->URLDoRelative}', 'IDContacts': '{$resp->reqID}' } );";
	...
	$modalButtonActionOnClick = /** @lang JavaScript */
		"xanDo( { 'Do': '{$xanDoDo}', 'Msg': 'Contact Delete', 'URL': '{$mmAPIRequestsT->URLDoRelative}', 'IDContacts': '{$resp->reqID}' } );";
	...
	$modal = new \xan\eleModal( $xanDoDo );
	$modalButtonActionOnClick = /** @lang JavaScript */
		"xanDo( { 'Do': '{$xanDoDo}', 'Msg': 'Comm Create', 'URL': '{$mmAPIRequestsT->URLDoRelative}', 'IDContactsComms': '{$resp->reqID}' } );";
	...
	$modal->buttonActionDanger = true;
	$modalButtonActionOnClick = /** @lang JavaScript */
		"xanDo( { 'Do': '{$xanDoDo}', 'Msg': 'Comm Delete', 'URL': '{$mmAPIRequestsT->URLDoRelative}', 'IDContacts': '{$resp->reqID}', 'IDContactsComms': window.ContactsCommsRecDelete_UUID } );";
	...
	$searchBarOnSearch = /** @lang JavaScript */
		"theSearchTerm = $( '#{$xanDoDo}_SearchTerm' ).val(); xanDo( { 'Do': '{$xanDoDo}', 'Msg': 'Contact Search', 'URL': '{$mmAPIRequestsT->URLDoRelative}', 'IDContacts': '{$resp->reqID}',  'SearchTerm': theSearchTerm } );";
