...
foreach ( $sessionFilePaths as $sessionName ) {
	...
	if ( strpos( $sessionName, "." ) === false ) { // This skips temp files that aren't sessions
		...
		if ( strpos( $_SESSION[ 'SES_BEGIN' ], "20" ) === 0 ) { // Starts with 20 like 2021-02-18 19:03:49
			...
			$table->cellSet( $tableRowIndex, ++$tableColIndex, $tagsCellLeftTop, $_SESSION[ 'recsUsersCURRENT' ][ UUIDTENANTS ] );
			$table->cellSet( $tableRowIndex, ++$tableColIndex, $tagsCellLeftTop, $_SESSION[ 'recsUsersCURRENT' ][ 'EmailAddress' ] . STR_BR . $_SESSION[ 'recsUsersCURRENT' ][ UUIDUSERS ] );
