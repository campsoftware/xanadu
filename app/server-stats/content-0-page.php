...
//         xanDo( { "Msg": "Initializing Elements", "URL": "{$mmServerStats->URLDoRelative}", "Do": "Init" } );
// JS;
//
// } else {
// 	$resp->scriptsOnLoadA[] = <<< JS
//         xanDo( { "Msg": "Loading Content and Initializing Elements", "URL": "{$mmServerStats->URLDoRelative}", "Do": "ContentLoadAll", "IDSettings": "{$resp->reqID}" } );
// JS;
}
