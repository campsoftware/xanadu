        ...
        <div class="float-right">
			<?php if ( xan\isNotEmpty( $resp->reqID ) ) : ?>
                ...
                <div class="dropdown-menu dropdown-menu-right border-1" role="menu" aria-labelledby="actionsMenu">
                    <a class="dropdown-item pl-2 pr-2" onclick='xanDo( { "Msg":"Printing PDF", "URL":"<?= $mmContactsT->URLDoRelative ?>", "Do":"ContactsPrint", "IDContacts":"<?= $resp->reqID ?>", "Format":"pdf", "Template":"pdf-default", "NewWindow":1 } );'><?= FA_PRINT . STR_NBSP ?>Print to PDF</a>
                    <a class="dropdown-item pl-2 pr-2" onclick='xanDo( { "Msg":"Printing HTML", "URL":"<?= $mmContactsT->URLDoRelative ?>", "Do":"ContactsPrint", "IDContacts":"<?= $resp->reqID ?>", "Format":"html", "Template":"pdf-default", "NewWindow":1 } );'><?= FA_PRINT . STR_NBSP ?>Print to HTML</a>
