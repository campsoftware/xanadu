...
class moduleMetaUsersPasswordReset extends xan\moduleMeta {
	// Constructor
	public function __construct() {
		parent::__construct();
		$this->NameModule = 'Password Reset';
		...
		$this->FontAwesome = '<i class=\'fas fa-parachute-box\'></i>';
		$this->FontAwesomeList = FA_LIST;
		
		$this->URLRelative = '/' . 'passwordreset/';
		$this->URLFull = URL_BASE . 'passwordreset/';
		
		$this->URLDoRelative = '/' . 'passwordreset-do/';
		$this->URLDoFull = URL_BASE . 'passwordreset-do/';
	}
...
// Init
$mmUsersPasswordReset = new moduleMetaUsersPasswordReset();
define( 'MM_USERS_PASSWORDRESET', 'MM_USERS_PASSWORDRESET' );
$mm[ MM_USERS_PASSWORDRESET ] = &$mmUsersPasswordReset;
?>